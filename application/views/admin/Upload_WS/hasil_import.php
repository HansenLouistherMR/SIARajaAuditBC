            ...
            <?php } ?>
              <div class="card mb-3">
                <div class="card-header">
                  <a href="<?php echo site_url('rajaaudit/admin/Upload_WS/') ?>"><i class="fa fa-arrow-left"></i> Back</a>
                </div>
                <div class="card-body">
                <div class="x_title">
                  <h2>Hasil Import Worksheet</h2>
                    ...
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                       <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            <?php $j = 1; ?>
                            <?php foreach ($data_upload as $key=>$element): ?>
                            <tr>
                              <td width="70"><?php echo $j ;?></td>
                              <td width="70"><?php print $element['Company_name'] ?></td>
                              <td width="70"><?php print $element['Account_No'] ?></td>
                              <td width="70"><?php print $element['Opening_Balance'] ?></td>
                              <!-- <td><?php print $element['Account_No'] ?></td>
