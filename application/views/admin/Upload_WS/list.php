              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <!-- <ul class="nav navbar-right panel_toolbox"><a href="<?php echo site_url('admin/siswa/add') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Siswa</a></ul>
                   ...
                   <ul class="nav navbar-right panel_toolbox"><a href="#"  data-toggle="modal" data-target="#tambahModal" class="btn btn-success"><i class="fa fa-plus"></i> Upload Worksheet</a></ul>
      ...
      <!-- Filter Modal -->
        ...
        <div class="modal fade" id="tambahModal" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title"> Upload Worksheet </h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
              </div>
              <div class="modal-body">
                <div class="col-md-12 col-sm-12">  
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <?php } ?>
                  ...
                  <form action="<?php print site_url();?>/admin/Upload_WS/upload" class="excel-upl" id="excel-upl" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    <div class="form-group col-md-12 col-sm-12">
