                    ...
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                       <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            <?php $j = 1; ?>
                            <?php foreach ($data_kuliah as $data_kuliah): ?>
                              
                            <tr>
                              <td align="center"><?php echo $j ?></td>
                              <td align="left" ><?php echo $data_kuliah->NIDN ?></td>
                              <td align="left" ><?php echo $data_kuliah->NAMA_DOSEN ?></td>
                              <td align="left" ><?php echo $data_kuliah->KD_MK ?></td>
                              <td align="left" ><?php echo $data_kuliah->NAMA_MK ?></td>
                              <td align="center" ><?php echo $data_kuliah->Tanggal ?></td>   
                              <td align="center" ><?php echo $data_kuliah->Hari ?></td>          
                              <td align="center" ><?php echo $data_kuliah->JamMulai ?></td>     
                              <td align="center" ><?php echo $data_kuliah->JamSelesai ?></td>       
                              <td align="center" ><?php echo $data_kuliah->pertemuan ?></td>                                                    
                             
                              <!-- <td 
                                <?php 
                                 if ($data_kuliah->cek == 1){
                                  echo 'bgcolor="#FF3333"';
                                } 
                                ?> >
                                <?php 
                                if ($data_kuliah->cek == 1){
                                ?>
                                  <a href="<?php echo $data_kuliah->link ?>" target="_blank"><?php echo $data_kuliah->link ?></a>
                                <?php
                                }else{ 
                                ?>
                                  <a href="<?php echo $data_kuliah->link ?>" target="_blank"><?php echo $data_kuliah->link ?></a>
                              ...
                              <td align="center">
                              <a href="<?php echo site_url('admin/spmi/edit/'.$data_kuliah->id) ?>" style="margin-right: 10px"><i class="fa fa-edit"></i> Edit</a>
                              </td> 
                              ...
                              <!-- <td align="center">
                                ...
                                <a href="<?php echo site_url('admin/data_kuliah_universitas/edit/'.$repository_llpm->id_repository) ?>" style="margin-right: 10px"><i class="fa fa-edit"></i> Edit</a>
