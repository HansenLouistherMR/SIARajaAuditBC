...
<body class="nav-md">
 ...
 -->
            ...
            <div class="card-body">
              <div class="x_title" >
                <h2 >Rekap Penerimaan & Pengeluaran <?php $this->load->helper('bulan_helper');
                echo bulan($bulan) ?> <?php echo $tahun ?></h2>
               ...
               <div class="row col-sm-12 col-md-12" style="display: inline-block;" align="center" >
                <div class="top_tiles" >
                  <div class="col-md-4 col-sm-4  tile">
                    ...
                    <h2>Rp. <?php $this->load->helper('rupiah_helper');
                    echo rupiah($pemasukkan) ?></h2>
                  </div>
                ...
                <div class="top_tiles" >
                  <div class="col-md-4 col-sm-4  tile">
                    ...
                    <h2>Rp. <?php $this->load->helper('rupiah_helper');
                    echo rupiah($pengeluaran) ?></h2>
                  </div>

                </div>
                <div class="top_tiles" >
                  <div class="col-md-4 col-sm-4  tile">
                    <span>Saldo Bulan <?php $this->load->helper('bulan_helper');
                    echo bulan($bulan) ?> <?php echo $tahun ?> </span>
                    <h2>Rp. <?php $this->load->helper('rupiah_helper');
                    echo rupiah($saldo) ?></h2>
                  </div>
                    ...
                    <table id="tes" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        ...
                        <tr bgcolor="C0C0C0" align="center">
                          <th style="width: 70px" colspan="2" rowspan="2">
                          Account No
                          </th>
                          <th style="width: 150px" colspan="2" rowspan="2">
                          Account Name
                          </th>
                          <th style="width: 150px">Saldo Awal 31/12/2022</th>
                          <th style="width: 150px" colspan="2">Mutasi Tahun Berjalan</th>
                          <th style="width: 150px">Saldo Unaudit 31/12/2023</th>
                          <th style="width: 150px" colspan="3">Jurnal Reklasifikasi</th>
                          <th style="width: 150px">Saldo 31/12/2023</th>
                          <th style="width: 150px" colspan="4">Jurnal Koreksi</th>
                          <th style="width: 150px" colspan="3">Jurnal Reklasifikasi</th>
                        ...
                        <tr bgcolor="C0C0C0" align="center">
                          ...
                          <td>
                            Ending Balance Audit 2023
                          </td>
                          <td>
                            Ending Balance Audit 2022
                          </td>
                          <td>
                            Kenaikan (Penurunan)
                          </td>
                        ...
                        <!-- <tr>
                          <td colspan="3" style="text-align: center !important; font-weight: bold;" bgcolor="FF9999">
                            Jumlah Total Debet <?php echo bulan($bulan) . " " . $tahun; ?> </td>
                          <td style="text-align: center !important; font-weight: bold;" bgcolor="FF9999"> Rp.
                            <?php $this->load->helper('rupiah_helper');
                            echo rupiah($pemasukkan) ?></td>
                          <td colspan="3" style="text-align: center !important; font-weight: bold;" bgcolor="9999FF">
                            Jumlah Total Kredit <?php echo bulan($bulan) . " " . $tahun; ?> </td>
                          <td style="text-align: center !important; font-weight: bold;" bgcolor="9999FF"> Rp.
                            <?php $this->load->helper('rupiah_helper');
                            echo rupiah($pengeluaran) ?></td>
                        </tr>
          ...
          <!-- <div class="card mb-3">
            ...
            <div class="card-body">
              <div class="x_title">
                <h2>Rekapitulasi Pertanggal <?php $this->load->helper('bulan_helper');
                echo bulan($bulan) ?>
                  <?php echo $tahun ?></h2>
                <div class="clearfix"></div>
              </div>
              <div align="right">
                <a href="<?php echo site_url('admin/rekapitulasi/printRekapBulananPertanggalExcel/' . $bulan . '/' . $tahun) ?>"
