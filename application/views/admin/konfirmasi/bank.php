...
<table border="1" id="" class="display table table-striped table-bordered" style="width:100%">
    <thead>
        ...
        <tr>
            ...
            <th style="width: 250px;" bgcolor="#9fb7b7">Rincian</th>
            <!-- <th style="width: 80px;" bgcolor="#9fb7b7">Account</th> -->
            <th style="width: 80px;" bgcolor="#9fb7b7">Saldo Per LK</th>
            <th style="width: 80px;" bgcolor="#9fb7b7">Mata Uang</th>
            <th style="width: 80px;" bgcolor="#9fb7b7">Saldo Per RK</th>
            <th style="width: 80px;" bgcolor="#9fb7b7">Selisih Buku VS RK</th>
            <th style="width: 80px;" bgcolor="#9fb7b7">Arsip otorisasi & balasan</th>
            <th style="width: 80px;" bgcolor="#9fb7b7">Balasan </th>
            <th style="width: 80px;" bgcolor="#9fb7b7">Selisih Buku Vs Balasan </th>
            <!-- <th style="width: 80px;" bgcolor="#9fb7b7">Keterangan </th> -->
            <!-- <th style="width: 80px;" bgcolor="#9fb7b7">Aksi </th> -->
...
<table border="1" id="" class="display table table-striped table-bordered" style="width:100%">
    <thead>
        <tr>
            ...
            <th style="width: 80px;" bgcolor="#9fb7b7">Mata Uang</th>
            <!-- <th style="width: 80px;" bgcolor="#9fb7b7">Saldo Per RK</th> -->
            <!-- <th style="width: 80px;" bgcolor="#9fb7b7">Selisih Buku VS Giro</th> -->
            <!-- <th style="width: 80px;" bgcolor="#9fb7b7">Arsip otorisasi & balasan</th> -->
            <th style="width: 80px;" bgcolor="#9fb7b7">Balasan </th>
            <th style="width: 80px;" bgcolor="#9fb7b7">Selisih </th>
            <!-- <th style="width: 80px;" bgcolor="#9fb7b7">Keterangan </th> -->
            <!-- <th style="width: 80px;" bgcolor="#9fb7b7">Aksi </th> -->
