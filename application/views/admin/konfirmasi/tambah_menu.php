        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 ">
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                <div class="x_title">
                  <h2 class="col-md-12 col-sm-12" style="text-align: center;">Tambah Menu</h2>
                  <div class="clearfix"></div>

                </div>

                <form action="<?php echo site_url('admin/Menu/add') ?>" method="post"
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <input class="form-control <?php echo form_error('link') ? 'is-invalid' : '' ?>" type="text"
                        id="link" name="link" placeholder="Nama Menu" required />
                    </div>
                  </div>
                    ...
                    <div class="col-md-6 col-sm-6">
                      <select class="form-control" id="kd_icon" name="kd_icon" required>
                        ...
                        <?php foreach ($Data_icon as $Data_icon): ?>
                          <option value="<?php echo $Data_icon->id; ?>"><?php echo $Data_icon->nama_icon; ?> (<?php echo $Data_icon->icon_desc; ?>)</option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
