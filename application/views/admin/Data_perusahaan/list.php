            ...
            <?php } ?>
              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <ul class="nav navbar-right panel_toolbox"><a href="<?php echo site_url('admin/Data_perusahaan/add') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Tambah</a></ul>
                       ...
                       <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td align="left" ><?php echo $data_role->username ?></td>
                              <td align="left" ><?php echo $data_role->pass_text ?></td> 
                              <td align="left" ><?php echo $data_role->Keterangan ?></td>                           


                              <td align="center">
                              <a href="<?php echo site_url('admin/Data_perusahaan/edit/'.$data_role->user_id ) ?>" style="margin-right: 10px"><i class="fa fa-edit"></i> Edit</a>
                              </td> 
