...
<html lang="en">
  ...
  <body class="nav-md">
    ...
    <strong>Pemberitahuan!</strong> Ini adalah pesan pemberitahuan penting.
</div>
<br>
        ...
        <a href="<?php echo site_url('admin/repository_lppm_universitas') ?>" style="text-decoration: none; color: inherit;">
            <div class="count_top"><i class="fa fa-user"></i> Data Repository</div>
            <div class="count" style="font-size: 24px;">123</div> <!-- Ini adalah contoh jumlah data -->
            <div class="count_bottom">Total Data</div>
        </a>
    </div>
