                       ...
                       <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td align="left" ><?php echo $data_role->nama_role ?></td>
                              <td align="left" ><?php echo $data_role->kode_role ?></td>
                              <td align="left" ><?php echo $data_role->Keterangan ?></td>


                              <td align="center">
                              <!-- <a href="<?php echo site_url('admin/spmi/edit/'.$data_role->id) ?>" style="margin-right: 10px"><i class="fa fa-edit"></i> Edit</a> -->
                              </td> 
