        ...
        <div class="right_col" role="main">
          <div class="row">
            ...
            <?php } ?>
              ...
              <div class="x_panel">
                <div class="x_title">
                  <h2><b>Audit Mutu Internal (AMI) Simulasi</b></h2>
                    ...
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                       <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            <?php $j = 1; ?>
                            <?php foreach ($data_spmi as $data_spmi): ?>
                              
                            <tr>
                              <td align="center"><?php echo $j ?></td>
                              <td align="left" ><?php echo $data_spmi->keterangan ?></td>
                              ...
                              <td 
                                ...
                                if ($data_spmi->cek == 1){
                                ?>
                                  <a href="<?php echo $data_spmi->link ?>" target="_blank">Cek Link</a>
                                <?php
                                }else{ 
                                ?>
                                  <a href="<?php echo $data_spmi->link ?>" target="_blank">Cek Link</a>
                              ...
                              <td align="left" ><?php echo $data_spmi->auditor ?></td>
                              <td align="left" > <a href="<?php echo $data_spmi->dok_foto ?>" target="_blank">Cek Link</a></td>
                              <td align="left" > <a href="<?php echo $data_spmi->dok_vid ?>" target="_blank">Cek Link</a></td>                   
                              ...
                              <!-- <td align="center">
                                ...
                                <a href="<?php echo site_url('admin/data_spmi_universitas/edit/'.$repository_llpm->id_repository) ?>" style="margin-right: 10px"><i class="fa fa-edit"></i> Edit</a>
