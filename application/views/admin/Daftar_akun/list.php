                    ...
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                       <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            <?php $j = 1; ?>
                            <?php foreach ($daftar_akun as $daftar_akun): ?>
                              
                            <tr>
                              <td align="center"><?php echo $j ?></td>
                              <td align="center" ><?php echo $daftar_akun->id_akun ?></td>
                              <td align="left" ><?php echo $daftar_akun->nama_akun ?></td>
                              <td align="left" ><?php echo $daftar_akun->Keterangan ?></td>
                              ...
                              <!-- <td align="center">
                                ...
                                <a href="<?php echo site_url('admin/daftar_akun_universitas/edit/'.$repository_llpm->id_repository) ?>" style="margin-right: 10px"><i class="fa fa-edit"></i> Edit</a>
