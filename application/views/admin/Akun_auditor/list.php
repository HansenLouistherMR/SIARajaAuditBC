            ...
            <?php } ?>
              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <ul class="nav navbar-right panel_toolbox"><a href="<?php echo site_url('admin/Akun_auditor/add') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Akun</a></ul>
                       ...
                       <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td align="left" ><?php echo $data_role->nama_akun ?></td>
                              <!-- <td align="left" ><?php echo $data_role->link ?></td>
                              <td align="left" ><?php echo $data_role->icon_desc ?></td> -->


                              <td align="center">
                              <a href="<?php echo site_url('admin/Akun_auditor/edit/'.$data_role->id) ?>" style="margin-right: 10px"><i class="fa fa-edit"></i> Edit</a>
                              <a onclick="deleteConfirm('<?php echo site_url('admin/Akun_auditor/delete/'.$data_role->id) ?>')" href="#!" ><i class="fa fa-trash"></i> Hapus</a>
                              </td> 
