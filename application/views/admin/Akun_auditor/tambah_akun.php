        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 ">
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                <div class="x_title">
                  <h2 class="col-md-12 col-sm-12" style="text-align: center;">Tambah Akun Auditor</h2>
                  <div class="clearfix"></div>

                </div>

                <form action="<?php echo site_url('admin/Akun_auditor/add') ?>" method="post"
                  enctype="multipart/form-data">

                  <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="nama_menu">Daftar Akun</label>
                  ...
                  <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="kode_role">List Akun</label>
                    <div class="col-md-6 col-sm-6">
                    <input class="form-control <?php echo form_error('List') ? 'is-invalid' : '' ?>" type="text"
                    id="List" name="List" placeholder="List Akun" required />
                    </div>
                  </div>

                  <!-- <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="link">Keterangan</label>
                    <div class="col-md-6 col-sm-6 ">
                      <input class="form-control <?php echo form_error('link') ? 'is-invalid' : '' ?>" type="text"
                        id="Keterangan" name="Keterangan" placeholder="Keterangan" required />
                    </div>
                  </div> -->
