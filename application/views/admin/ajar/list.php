                       ...
                       <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td align="center" ><?php echo $data_ajar->Tanggal_new ?></td>   
                              <td align="center" ><?php echo $data_ajar->Hari ?></td>          
                              <td align="center" ><?php echo $data_ajar->JamMulai ?></td>     
                              <td align="center" ><?php echo $data_ajar->JamSelesai ?></td>                       
                              ...
                              <!-- <td 
                                ...
                                if ($data_ajar->cek == 1){
                                ?>
                                  <a href="<?php echo $data_ajar->link ?>" target="_blank"><?php echo $data_ajar->link ?></a>
                                <?php
                                }else{ 
                                ?>
                                  <a href="<?php echo $data_ajar->link ?>" target="_blank"><?php echo $data_ajar->link ?></a>
                              ...
                              <td align="center">
                              <a href="<?php echo site_url('admin/spmi/edit/'.$data_ajar->id) ?>" style="margin-right: 10px"><i class="fa fa-edit"></i> Edit</a>
                              </td> 
