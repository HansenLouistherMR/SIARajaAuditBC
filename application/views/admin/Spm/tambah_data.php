                  ...
                  <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" id="hrd-tab" data-toggle="tab" href="#hrd-legal" role="tab"
                        ...
                        onclick="showDiv('hrd-legal')">SURV. PENDAHULUAN</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="finance-tab" data-toggle="tab" href="#finance-dept" role="tab"
                        ...
                        onclick="showDiv('finance-dept')">EV. PENERIMAAN KLIEN</a>
                    </li>
                    <!-- khusus auditor -->
                      ...
                      <li class="nav-item">
                        <a class="nav-link" id="spm-tab" data-toggle="tab" href="#spm-dept" role="tab"
                          ...
                          onclick="showDiv('spm-dept')">PERNY. INDEPENDENSI</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="spm-tab" data-toggle="tab" href="#spm-dept" role="tab"
                          aria-controls="spm-dept" aria-selected="false" style="color: red;"
                          onclick="showDiv('spm-dept')">PEMAHAMAN BISNIS</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="spm-tab" data-toggle="tab" href="#spm-dept" role="tab"
                          aria-controls="spm-dept" aria-selected="false" style="color: red;"
                          onclick="showDiv('spm-dept')">PERH. MATERIALITAS</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="spm-tab" data-toggle="tab" href="#spm-dept" role="tab"
                          aria-controls="spm-dept" aria-selected="false" style="color: red;"
                          onclick="showDiv('spm-dept')">PEN. RISIKO</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="spm-tab" data-toggle="tab" href="#spm-dept" role="tab"
                          aria-controls="spm-dept" aria-selected="false" style="color: red;"
                          onclick="showDiv('spm-dept')">SUBSEQUENT</a>
                      </li>
