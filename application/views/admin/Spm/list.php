              ...
              <div class="x_title">
                ...
                <?php if (empty($user_id)) { ?>
                  ...
                  <ul class="nav navbar-right panel_toolbox"><a
                    href="<?php echo site_url('admin/Upload_perusahaan/addperushaan') ?>" class="btn btn-success"><i
                      class="fa fa-plus"></i> Tambah Baru</a></ul>
                        ...
                        <tbody>
                          ...
                          <?php foreach ($data_role as $data_role): ?>
                            ...
                            <tr>
                              ...
                              <td align="left"><?php echo $data_role->user_id ?></td>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" action="<?php echo site_url('admin/bayar_catering/getCateringByNoBulanTahun') ?>"
                method="post">
